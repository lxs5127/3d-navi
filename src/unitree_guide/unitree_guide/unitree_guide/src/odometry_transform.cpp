...
double x=0, y=0, z=0, roll=0, pitch=0, yaw=-1.59;
...
void callback_Odometry(const nav_msgs::Odometry::ConstPtr &msg) {
    ...
    Odom.pose.pose.position.x = pt_odom.getX();
    Odom.pose.pose.position.y = pt_odom.getY();
    Odom.pose.pose.position.z = pt_odom.getZ();
    
    Odom.pose.pose.orientation.w = q_map.getW() ;
    Odom.pose.pose.orientation.x = q_map.getX()  ;
    Odom.pose.pose.orientation.y = q_map.getY() ;
    Odom.pose.pose.orientation.z = q_map.getZ() ;
    // set the velocity 
